...
```
As shown above, for this example, tortto `Conv2d` is about 2 times slower than pytorch.  
<br />
...
[resnet50 (finetune)](https://github.com/samrere/pytortto/blob/main/examples/resnet/resnet50_finetune) | **96.31%**| (64,128,256,512) | bottleNeck:(3,4,6,3) | 15 | 20.65 | 8.82 | 20.65/8.82=2.3
...
<p align="center">
  <img src="https://drive.google.com/uc?export=view&id=1aqoiqh-4Surz58wLNNIrRKURcc5l3PFW" width="600">
</p>
...
#### nn.modules  
* activation: `Tanh`, `Sigmoid`, `LogSigmoid`, `ReLU`, `GELU`, `Softmax`, `LogSoftmax`, `MultiheadAttention`    
