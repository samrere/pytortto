...
## Finetuned model
download the finetuned trained model from [here](https://drive.google.com/file/d/1TF6MIPZM7FaUIIxAf4DeOgNkEnI4wRu4/view?usp=sharing) (318 MB), extract the file `checkpoint_014.npy` and put it in the same directory as the jupyter notebook.